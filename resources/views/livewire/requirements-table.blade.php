            ...
            @foreach ($requirements as $requirement)
                <tr class="fi-ta-row hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="fi-ta-cell px-4 py-2 text-sm text-gray-900 dark:text-gray-300 flex flex-row items-center gap-4">
                        ...
                        <div class="cursor-pointer" wire:click="viewImage('{{ $requirement }}')">
                        ...
                        <div wire:click="chooseFile('{{$requirement}}')" id="upload_document" onclick="document.getElementById('documentInput{{$record->id}}').click();" class="cursor-pointer">
                        ...
                        @if ($document)
                            <div wire:click="uploadDoc" class="cursor-pointer">
