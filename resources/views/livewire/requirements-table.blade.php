        ...
        <table class="fi-ta-table w-full divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
            ...
            @foreach ($requirements as $requirement)
                <tr class="fi-ta-row hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="fi-ta-cell px-4 py-2 text-sm text-gray-900 dark:text-gray-300 flex flex-row justify-center items-center gap-2" >
            ...
            <tr class="fi-ta-row">
                <td colspan="5" class="fi-ta-cell px-4 py-2 text-sm text-gray-900 dark:text-gray-300">
