...
const homeMatchCalculator = ref(null);
const homeMatchCalculatorOptions = [
        { title: 'Default 1', description: 'Default 1', current: true },
        { title: 'Default 2', description: 'Default 2', current: false },
    ]
...
watch(() => form.sku, (newValue, oldValue) => {
...
<template>
    <DefaultLayout>
        <div>
            <div class="bg-[url('../images/ModelUnitWalkthrough.gif')] bg-cover bg-center h-80 w-full flex items-end">
                <div class="inset-0 bg-gradient-to-t from-white to-transparent opacity-100 h-40 w-full bottom-0 flex items-end pb-4 ps-4">
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm">Range: ₱ 850K - 6M</span>
                    </div>
                </div>
            </div>
            {{ form.sku }}
            <div class="px-3 pt-2">
                <div class="flex flex-row">
                    <div class="basis-4/6">
                        <SecondaryDropdown 
                            :options="homeMatchCalculatorOptions"
                            v-model="homeMatchCalculator"
                            label="Home Match Calculator"
                        >
                            <template #icon>
