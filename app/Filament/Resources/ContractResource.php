                                                                ...
                                                                if(ModelsContact::where('order->property_code', $get('contact_data.order.property_code'))->count() > 0 && Contact::where('order->property_code', $get('contact_data.order.property_code'))->first()->id != $record->contact_id){
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if ($response->successful()) {
                                                                            ...
                                                                            $set('contact_data.order.project_location', $response->json()['data']['project']['location']??'');
                                                                            ...
                                                                            $set('contact_data.order.project_address', $response->json()['data']['project']['address']??'');
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if ($response->successful()) {
                                                                            ...
                                                                            Notification::make()
                                                                                ...
                                                                                ->body($response->json()['inventory']['technical_description'])
                                                                                ->success()
                                                                                ->persistent()
                                                                                ->sendToDatabase(auth()->user())
                                                                                ->send();
